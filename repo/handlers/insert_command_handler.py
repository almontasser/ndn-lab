...
from group_messages.add import AddMessageTlv, BackupTlv, FetchPathTlv
...
from protocol.base_modules import File, InsertCommand
from utils.pubsub import PubSub

class InsertCommandHandler(ProtocolHandler):
    """
    ...
    def __init__(self, app: NDNApp, data_storage: Storage, pb: PubSub, config: dict,
        ...
        """
        super(InsertCommandHandler, self).__init__(app, data_storage, pb, config)
        self.prefix = None
