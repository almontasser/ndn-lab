...
from group_messages.claim import ClaimMessageTlv, ClaimTypes
from group_messages.heartbeat import HeartbeatMessageTlv
from group_messages.message import Message, MessageTypes
from group_messages.store import StoreMessageTlv
from modules.favor_calculator import FavorParameters
from modules.file_fetcher import FileFetcher
from modules.global_view import GlobalView
from modules.heartbewat_tracker import HeartbeatTracker
from utils.garbage_collector import collect_db_garbage
...
class MainLoop:
    def __init__(self, app:NDNApp, config:Dict, global_view:GlobalView, data_storage:Storage, svs_storage:Storage, file_fetcher:FileFetcher):
        ...
        self.tracker = HeartbeatTracker(
            ...
            config['tracker_rate'],
            config['beats_to_fail'],
            config['beats_to_renew'])
